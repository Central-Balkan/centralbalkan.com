...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://centralbalkan.com",
  },
  keywords: [
    "метални изделия",
    "CNC лазерно рязане",
  ...
  openGraph: {
    title: "Централен Балкан | CNC лазерно рязане и металообработка",
    description:
      "Професионално CNC лазерно рязане и металообработка. Над 30 години опит в серийното производство на метални изделия по чертеж.",
  ...
  twitter: {
    ...
    title: "Централен Балкан | CNC лазерно рязане и металообработка",
    description:
      "Над 30 години опит в производството на метални изделия и прецизно CNC лазерно рязане.",
